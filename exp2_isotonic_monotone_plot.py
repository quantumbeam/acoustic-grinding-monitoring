...
def load_dataset(dataset_path: str) -> pd.DataFrame:
    if not os.path.exists(dataset_path):
        raise FileNotFoundError(
            ...
            "Run exp2_gpr_model.py first to generate results/exp2_gpr_dataset_raw.csv."
        )
...
def plot_models(
    ...
    plt.savefig(os.path.join(outdir, f"{base}.pdf"), dpi=300)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset",
        type=str,
        default=os.path.join("results", "exp2_gpr_dataset_raw.csv"),
