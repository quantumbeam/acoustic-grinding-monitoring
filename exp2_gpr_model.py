...
if __name__ == '__main__':
    ...
    for current_reagent in np.unique(data_array[:, 4]):
        ...
        plt.legend()
        plot_path_pdf = os.path.join(MODEL_DIR, f"{EXPERIMENT}_gpr_plot_{direction}_{current_reagent}.pdf")
        plot_path_png = os.path.join(MODEL_DIR, f"{EXPERIMENT}_gpr_plot_{direction}_{current_reagent}.png")
